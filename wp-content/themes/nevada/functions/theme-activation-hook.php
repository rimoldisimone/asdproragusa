...
function lambda_register_required_plugins() {
	...
	$config = array(
		...
		'strings'      		=> array(
			'page_title'                       			=> __( 'Install Required Plugins', 'Nevada' ),
			'menu_title'                       			=> __( 'Install Plugins', 'Nevada' ),
			'installing'                       			=> __( 'Installing Plugin: %s', 'Nevada' ), // %1$s = plugin name
			'oops'                             			=> __( 'Something went wrong with the plugin API.', 'Nevada' ),
			...
			'return'                           			=> __( 'Return to Required Plugins Installer', 'Nevada' ),
			'plugin_activated'                 			=> __( 'Plugin activated successfully.', 'Nevada' ),
			'complete' 									=> __( 'All plugins installed and activated successfully. %s', 'Nevada' ), // %1$s = dashboard link
