...
if ( ! function_exists( 'portfolio_register' ) ) {
	...
	function portfolio_register() {  
		 ...
		 $args = array(
				'hierarchical' => true,
				'label' => __('Portfolio', 'Nevada'),
				'singular_label' => __('Project', 'Nevada'),
				'public' => true,
				'show_ui' => true,
...
#----------------------------------------------------------------- 
register_taxonomy(__("project-type" , 'Nevada' ), 
		array(UT_PORTFOLIO_SLUG), 
		array("hierarchical" => true, 
				"label" => __( 'Project Categories', 'Nevada'), 
				"singular_label" => __( 'Project Category', 'Nevada'), 
				"rewrite" => true)
);
