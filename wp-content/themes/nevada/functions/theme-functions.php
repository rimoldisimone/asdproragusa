...
if( !function_exists( 'register_menu' ) ) :
	...
	function register_menu() {
	    register_nav_menu('primary-menu', __('Primary Navigation', 'Nevada'));
...
if ( !function_exists( 'lambda_continue_reading_link' ) ) {
	function lambda_continue_reading_link() {
		return '<a class="excerpt" href="'. get_permalink() . '">' . __( 'Read More', 'Nevada' ) . '</a>';
	}
}
...
function new_excerpt_more($more) {
	...
	$more = __('Read more <span class="meta-nav"></span>', 'Nevada');
