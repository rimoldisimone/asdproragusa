                    ...
                    <article class="comment-body">
                    	...
                    	<header class="comment-header">
							...
							<?php if ($comment->comment_approved == '0') : ?>
                            	<em><?php _e('Comment is awaiting moderation','Nevada');?></em> <br />
                            <?php endif; ?>
							
                            <cite class="fn"><?php echo get_comment_author_link(); ?></cite>
                             <br />
                            <span class="comment-date"><?php echo get_comment_date(). '  -  ' . get_comment_time(); ?></span>
                            <?php comment_reply_link(array_merge( $args, array('reply_text' => __('Reply','Nevada'),'depth' => $depth, 'max_depth' => $args['max_depth']))); ?>
                        </header>
                        
						<?php comment_text() ?>
                        
                        <footer class="comment-meta commentmetadata">
							<?php edit_comment_link(__('Edit Comment','Nevada'),'  ',''); ?>
						</footer>
...
if ( ! function_exists( 'GetLambdaLikePost' ) ) {
	function GetLambdaLikePost($arg = null) {
		...
		$title_text_like = __('Like', 'Nevada');
