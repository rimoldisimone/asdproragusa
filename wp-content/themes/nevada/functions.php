...
function lambda_setup() {
	...
	#-----------------------------------------------------------------
	load_theme_textdomain( 'Nevada' , THEME_DOCUMENT_ROOT  . '/languages' );
...
function st_widgets_init() {
	...
	register_sidebar( array(
		'name' => __( 'Main Sidebar', 'Nevada' ),
		'id' => UT_THEME_INITIAL.'sidebar_default',
		'description' => __( 'The Default Sidebar', 'Nevada' ),
	...
	register_sidebar( array(
		'name' => __( 'First Footer Widget Area', 'Nevada' ),
		'id' => 'first-footer-widget-area',
		'description' => __( 'The first footer widget area', 'Nevada' ),
	...
	register_sidebar( array(
		'name' => __( 'Second Footer Widget Area', 'Nevada' ),
		'id' => 'second-footer-widget-area',
		'description' => __( 'The second footer widget area', 'Nevada' ),
		'before_widget' => '<div class="%1$s %2$s">',
		'after_widget' => '</div>',
		'before_title' => '<h3 class="widget-title"><span>',
		'after_title' => '</span></h3>',
	...
	register_sidebar( array(
		'name' => __( 'Third Footer Widget Area', 'Nevada' ),
		'id' => 'third-footer-widget-area',
		'description' => __( 'The third footer widget area', 'Nevada' ),
		'before_widget' => '<div class="%1$s %2$s">',
		'after_widget' => '</div>',
		'before_title' => '<h3 class="widget-title"><span>',
		'after_title' => '</span></h3>',
	...
	register_sidebar( array(
		'name' => __( 'Fourth Footer Widget Area', 'Nevada' ),
		'id' => 'fourth-footer-widget-area',
		'description' => __( 'The fourth footer widget area', 'Nevada' ),
		'before_widget' => '<div class="%1$s %2$s">',
		'after_widget' => '</div>',
		'before_title' => '<h3 class="widget-title"><span>',
		'after_title' => '</span></h3>',
	...
	register_sidebar( array(
		'name' => __( 'Header Widget Area', 'Nevada' ),
		'id' => 'header-widget-area',
		'description' => __( 'The header widget area. Only for Lambda Social Media Widget', 'Nevada' ),
		'before_widget' => '<div class="%1$s %2$s">',
		'after_widget' => '</div>',
		'before_title' => '<h3 class="widget-title"><span>',
		'after_title' => '</span></h3>',
...
function lambda_posted_on() {
	return sprintf( __( '%2$s', 'Nevada' ),
		...
		sprintf( '<span class="author vcard"><a class="url fn n" href="%1$s" title="%2$s">%3$s</a></span>',
			...
			sprintf( esc_attr__( 'View all posts by %s', 'Nevada' ), get_the_author() ),
			get_the_author()
		)
	);
}
