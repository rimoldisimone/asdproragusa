...
if ( have_posts() ) : ?>
				<p class="search-title"><?php printf( __( 'Search Results for:<span> %s </span>', 'Nevada' ), '' . get_search_query() . '' ); ?></p>
				<?php
...
<?php else : ?>
				<div id="post-0" class="post no-results not-found">
					<p class="search-title"><?php _e( 'Nothing Found', 'Nevada' ); ?></p>
					
					<p><?php _e( 'Sorry, but nothing matched your search criteria. Please try again with some different keywords.', 'Nevada' ); ?></p>
						<?php get_search_form(); ?>
