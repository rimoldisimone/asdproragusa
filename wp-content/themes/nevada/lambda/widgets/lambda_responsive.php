...
class WP_Widget_Responsive extends WP_Widget {
	...
	function __construct() {
		$widget_ops = array('classname' => 'lambda_widget_responsive', 'description' => __( 'Responsive On / Off Switch', 'Nevada') );
		parent::__construct('lw_responsive', __('Lambda - Responsive Switch', 'Nevada'), $widget_ops);
	...
	function form($instance) { 
		...
		$buttontype = array(
			'plain' => __('Plain Text', 'Nevada'),
			'button' => __('Button', 'Nevada')
		); ?>	
		
        <p>
            <label for="<?php echo $this->get_field_id('button_type'); ?>"><?php _e('Switch Layout', 'Nevada'); ?>:<br />
		...
		<?php $buttoncolors = array(
			'gray' => __('gray', 'Nevada'),
			'blue' => __('blue', 'Nevada'),
			'green' => __('green', 'Nevada'),
			'orange' => __('orange', 'Nevada'),
			'purple' => __('purple', 'Nevada'),
			'red' => __('red', 'Nevada'),
			'coffee' => __('brown', 'Nevada'),
			'pink' => __('pink', 'Nevada')
		); ?>	
		
        <p>
            <label for="<?php echo $this->get_field_id('button_color'); ?>"><?php _e('Button Color', 'Nevada'); ?>:<br />
        ...
        <p>
        	<label for="<?php echo $this->get_field_id('mobile'); ?>"><?php _e('Button Text for Mobile Switch', 'Nevada'); ?>:<br />
        ...
        <p>
        	<label for="<?php echo $this->get_field_id('desktop'); ?>"><?php _e('Button Text for Desktop Switch', 'Nevada'); ?>:<br />
