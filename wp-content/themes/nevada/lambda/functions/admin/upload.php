  ...
  <div class="option option-upload" id="<?php echo $value->item_id; ?>_div">
    <div class="lambda-opttitle">
      ...
      <div class="element">
        ...
        <button style="margin-left:0px; margin-top:10px;" id="upload_<?php echo $value->item_id; ?>" class="upload_button btn btn-success" rel="<?php echo $int; ?>" /><i class="icon-picture icon-white"></i> <?php _e('Upload', 'Nevada'); ?></button>
