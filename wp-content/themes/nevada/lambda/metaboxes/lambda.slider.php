...
<div class="ui-panelcontent">
	...
	<div class="container block">
			...
			<div class="meta-headline">
				...
				<h1><?php _e( 'Featured Header', 'Nevada' ); ?></h1>
				<div class="clear"></div>
			...
			<div class="six columns">
				...
				<div class="lambda-opttitle">
					...
					<div class="lambda-opttitle-pad">
						<i class="icon-list-alt icon-black"></i><?php _e( 'Choose Header Type', 'Nevada' ); ?>
					</div>
				...
				<div class="slider_type_details">		
					...
					<?php 
					$slidertype = array (
						'' 					=> __( 'Choose Header Type', 'Nevada' ),
						'static_image' 		=> __( 'Static Image', 'Nevada' ),
						'static_video' 		=> __( 'Static Video', 'Nevada' ),
						'static_slider' 	=> __( 'Slider', 'Nevada' ),
						'static_textvideo' 	=> __( 'Static Video + Text', 'Nevada' )
					);
					...
					<div id="static_image" class="ss_box">
						...
						<p>   
                            <label><?php _e( 'Static Image', 'Nevada' ); ?></label>
                            <?php echo $wpalchemy_media_access->getField(array('name' => $mb->get_the_name(), 'value' => $mb->get_the_value())); ?>
							<br /><span class="badge badge-info"><?php _e( 'This Image should be at least 980px wide', 'Nevada' ); ?></span><br />
						...
						<p>
							<label><?php _e( 'URL (optional)', 'Nevada' ); ?></label>
							<?php $mb->the_field('static_image_url'); ?>
							<input type="text" name="<?php $mb->the_name(); ?>" value="<?php $mb->the_value(); ?>"/>
						</p>
							
						<p>
							<label><?php _e( 'Caption (optional)', 'Nevada' ); ?></label>
						...
						<div class="btn-group" style="margin-bottom:15px;">
							<label><?php _e( 'Image width', 'Nevada' ); ?></label>
							...
							<button data-state="static_image_size_on" class="btn <?php echo $activestate; ?> radio_active" type="button" value="on"><?php _e( 'centered', 'Nevada' ); ?></button>
							...
							<button data-state="static_image_size_off" class="btn <?php echo $deactivestate; ?> radio_inactive" type="button" value="off"><?php _e( 'fullwidth', 'Nevada' ); ?></button>	
							...
							<span class="badge badge-info"><?php _e( 'only takes effect on full width layouts!', 'Nevada' ); ?></span>	
						</div>
					...
					<div id="static_textvideo" class="ss_box">
						...
						<div class="lambda-opttitle">
						<div class="lambda-opttitle-pad">
							<?php _e( 'Static Video & Text', 'Nevada' ); ?>
							</div>
						</div>
						...
						<p><label><?php _e( 'Headline', 'Nevada' ); ?></label>
						...
						<div class="colorform">	
							...
							<label class="cp_box_label"><?php _e('Headline Color', 'Nevada'); ?></label>
							<input id="featured_headline_color" type="text" name="<?php $mb->the_name(); ?>" value="<?php $mb->the_value(); ?>"/>
						</div>
						
							
						<p><label><?php _e( 'Text', 'Nevada' ); ?></label>
						...
						<div class="colorform">		
							...
							<label class="cp_box_label"><?php _e('Textcolor', 'Nevada'); ?></label>
							<input id="featured_text_color" type="text" name="<?php $mb->the_name(); ?>" value="<?php $mb->the_value(); ?>"/>
												
						</div>
						
						<p><label><?php _e( 'Buttontext', 'Nevada' ); ?></label>
						<?php $mb->the_field('featured_buttontext'); ?>
						<input type="text" name="<?php $mb->the_name(); ?>" value="<?php $mb->the_value(); ?>"/></p>
						
						<p><label><?php _e( 'Buttonlink', 'Nevada' ); ?></label>
						...
						<?php $wpalchemy_media_access->setGroupName('nonverbla_hd_url_slider'. $mb->get_the_index())->setInsertButtonLabel('Insert'); ?>
						<label><?php _e( 'Upload HD Video', 'Nevada' ); ?></label>
						<?php echo $wpalchemy_media_access->getField(array('name' => $mb->get_the_name(), 'value' => $mb->get_the_value())); ?>
						<br /><span class="info badge badge-info">(<?php _e('can be .mov, .flv', 'Nevada'); ?>)</span><br />
						<?php echo $wpalchemy_media_access->getButton(); ?>
						</p>
						...
						<label><?php _e( 'MP4 File URL', 'Nevada' ); ?></label>
						<?php echo $wpalchemy_media_access->getField(array('name' => $mb->get_the_name(), 'value' => $mb->get_the_value())); ?>
						<br /><span class="info badge badge-info">(<?php _e('The URL to .mp4 video file for Ipad', 'Nevada'); ?>)</span><br />
						<?php echo $wpalchemy_media_access->getButton(); ?>
						</p>    
...
<div class="slider_type_background ten columns">
	...
	<div class="lambda-opttitle">
		<div class="lambda-opttitle-pad">
			<i class="icon-align-justify icon-black"></i><?php _e( 'Hide Teaser / Page Title?', 'Nevada' ); ?>
		</div>
	</div>
	...
	<div class="lambda-settings-pad">
		...
		<div class="btn-group" style="height:40px;">
			...
			<button data-state="hide_teaser_on" class="btn <?php echo $activestate; ?> radio_active" type="button" value="teaseron"><?php _e( 'show', 'Nevada' ); ?></button>
			...
			<button data-state="hide_teaser_off" class="btn <?php echo $deactivestate; ?> radio_inactive" type="button" value="teaseroff"><?php _e( 'hide', 'Nevada' ); ?></button>	
	...
	<div class="lambda-opttitle">
		<div class="lambda-opttitle-pad">
			<i class="icon-picture icon-black"></i><?php _e( 'Background Settings', 'Nevada' ); ?>
		</div>
	</div>
	...
	<div class="lambda-settings-pad">
		...
		<p>
			...
			<select name="<?php $mb->the_name(); ?>" id="sbgstyle_type">
				<option value=""><?php _e( 'Choose Background Type', 'Nevada' ); ?></option>
				<option value="slider_default_backgroundimage" <?php $mb->the_select_state('slider_default_backgroundimage'); ?>> <?php _e( 'Image or Color', 'Nevada' ); ?> </option>
				<option value="slider_default_backgroundpattern" <?php $mb->the_select_state('slider_default_backgroundpattern'); ?>> <?php _e( 'Background Pattern', 'Nevada' ); ?> </option>
				<option value="slider_default_backgroundtexture" <?php $mb->the_select_state('slider_default_backgroundtexture'); ?>> <?php _e( 'Background Texture', 'Nevada' ); ?> </option>
			</select>
		</p>
