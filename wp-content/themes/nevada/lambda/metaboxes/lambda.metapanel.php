		...
		<div class="container block">
			...
			<div class="lambda-opttitle">
				<div class="lambda-opttitle-pad">
					<i class="icon-indent-right icon-black"></i><?php _e( 'Sidebar Settings', 'Nevada' ); ?>
				</div>
			</div>
			...
			<div class="lambda-opttitle">
				  <div class="lambda-opttitle-pad">
					<i class="icon-indent-left icon-black"></i><?php _e( 'Show Hide Author Box', 'Nevada' ); ?>
				  </div>
			</div>			
...
<div id="style-settings" class="style-settings tab-pane">
	<div class="ui-panelcontent">
		...
		<div class="container block">
			...
			<div class="lambda-opttitle">
				<div class="lambda-opttitle-pad">
					<i class="icon-picture icon-black"></i><?php _e( 'Main Background Settings', 'Nevada' ); ?>
...
<div id="portfolio-settings" class="portfolio-settings tab-pane">
	...
	<div class="ui-panelcontent">
		...
		<div class="container block">
			...
			<div class="lambda-opttitle">
				<div class="lambda-opttitle-pad">
					<span class="miniicon"><img src="<?php echo THEME_WEB_ROOT; ?>/lambda/assets/images/icons/tag_green.png"></span><?php _e( 'Choose Project Types', 'Nevada' ); ?>
				</div>
			</div>
			<div class="lambda-settings-pad">
				<p>
			...
			<div class="lambda-opttitle">
        		<div class="lambda-opttitle-pad">
            		<span class="miniicon"><img src="<?php echo THEME_WEB_ROOT; ?>/lambda/assets/images/icons/application_tile_horizontal.png"></span><?php _e( 'Portfolio Column Layout', 'Nevada' ); ?>
           		</div>
        	</div>
			...
			<div class="lambda-opttitle">
        		<div class="lambda-opttitle-pad">
            		<span class="miniicon"><img src="<?php echo THEME_WEB_ROOT; ?>/lambda/assets/images/icons/application_tile_horizontal.png"></span><?php _e( 'Portfolio Item Title', 'Nevada' ); ?>
           		</div>
        	</div>
		...
		<div class="container block">
			...
			<div class="sixteen columns">		
				...
				<div id="lambda-post-format-link" class="postf_box">
					...
					<div class="lambda-opttitle">
						<div class="lambda-opttitle-pad">
							<span class="miniicon"><img src="<?php echo THEME_WEB_ROOT; ?>/lambda/assets/images/icons/link.png"></span><?php _e( 'Link', 'Nevada' ); ?>
						</div>
					</div>
					<div class="lambda-settings-pad">
					...
					<div id="lambda-post-format-quote" class="postf_box">        
						<div class="post_format_quote">
							<div class="lambda-opttitle">
								<div class="lambda-opttitle-pad">
								<span class="miniicon"><img src="<?php echo THEME_WEB_ROOT; ?>/lambda/assets/images/icons/text_dropcaps.png"></span><?php _e( 'Quote', 'Nevada' ); ?>
								</div>
							</div>
							<div class="lambda-settings-pad">
					...
					<div class="lambda-opttitle">
						<div class="lambda-opttitle-pad">
						<span class="miniicon"><img src="<?php echo THEME_WEB_ROOT; ?>/lambda/assets/images/icons/video.png"></span><?php _e( 'Video Details', 'Nevada' ); ?>
					 </div>
					</div>
					<div class="lambda-settings-pad">						
				...
				<div class="post_format_video">
					<div class="lambda-opttitle">
						<div class="lambda-opttitle-pad">
						<span class="miniicon"><img src="<?php echo THEME_WEB_ROOT; ?>/lambda/assets/images/icons/sound.png"></span><?php _e( 'Audio Details', 'Nevada' ); ?>
					 </div>
					</div>
					<div class="lambda-settings-pad">
	...
	<div class="ui-panelcontent">
		...
		<div class="container block">
			...
			<div class="sixteen columns">
				...
				<div class="lambda-opttitle">
					<div class="lambda-opttitle-pad">
						<span class="miniicon"><img src="<?php echo THEME_WEB_ROOT; ?>/lambda/assets/images/icons/pencil_go.png"></span><?php _e( 'Project Type', 'Nevada' ); ?>
					</div>
				</div>
				...
				<div class="lambda-opttitle">
					<div class="lambda-opttitle-pad">
						<span class="miniicon"><img src="<?php echo THEME_WEB_ROOT; ?>/lambda/assets/images/icons/image_add.png"></span><?php _e( 'Manage your Video', 'Nevada' ); ?><br />
                ...
                <div class="lambda-opttitle-pad">
					<span class="miniicon"><img src="<?php echo THEME_WEB_ROOT; ?>/lambda/assets/images/icons/image_add.png"></span><?php _e( 'Manage your Project Items', 'Nevada' ); ?><br />
				...
				<div class="lambda-opttitle">
					<div class="lambda-opttitle-pad">
						<span class="miniicon"><img src="<?php echo THEME_WEB_ROOT; ?>/lambda/assets/images/icons/pencil_go.png"></span><?php _e( 'Work Description', 'Nevada' ); ?>
					</div>
				</div>
				<div class="lambda-settings-pad">
...
<div id="contact-settings" class="contact-settings tab-pane">
	...
	<div class="ui-panelcontent">
	   ...
	   <div class="container block">
		   ...
		   <div class="lambda-opttitle">
				<div class="lambda-opttitle-pad">
					<span class="miniicon"><img src="<?php echo THEME_WEB_ROOT; ?>/lambda/assets/images/icons/map.png"></span><?php _e( 'Google Maps', 'Nevada' ); ?>
				</div>
		   </div>
		   <div class="lambda-settings-pad">
		  ...
		  <div class="lambda-opttitle">
				<div class="lambda-opttitle-pad">
				<span class="miniicon"><img src="<?php echo THEME_WEB_ROOT; ?>/lambda/assets/images/icons/email_to_friend.png"></span><?php _e( 'Email Settings', 'Nevada' ); ?>
				</div>
		   </div>
		   <div class="lambda-settings-pad">
		   ...
		   <div class="lambda-opttitle">
				<div class="lambda-opttitle-pad">
				<span class="miniicon"><img src="<?php echo THEME_WEB_ROOT; ?>/lambda/assets/images/icons/email_add.png"></span><?php _e( 'Contact Form Builder', 'Nevada' ); ?><br />
...
<div id="team-settings" class="team-settings tab-pane">
	...
	<div class="ui-panelcontent">
	   ...
	   <div class="container block">
		   ...
		   <div class="lambda-opttitle">
				<div class="lambda-opttitle-pad">
					<span class="miniicon"><img src="<?php echo THEME_WEB_ROOT; ?>/lambda/assets/images/icons/user_add.png"></span><?php _e( 'Add Team Member', 'Nevada' ); ?>
				</div>
		   </div>
		   <div class="lambda-settings-pad">
	...
	<div class="ui-panelcontent">
		 ...
		 <div class="container block">
			...
			<div class="sixteen columns">
			   ...
			   <div class="lambda-opttitle">
					<div class="lambda-opttitle-pad">
						<span class="miniicon"><img src="<?php echo THEME_WEB_ROOT; ?>/lambda/assets/images/icons/add.png"></span><?php _e( 'Add FAQ Item', 'Nevada' ); ?>
					</div>
			   </div>
			   <div class="lambda-settings-pad">
					...
					<div class="clear"></div>
					<p style="margin-bottom:15px; padding-top:5px;"><a href="#" class="docopy-<?php echo UT_THEME_INITIAL.'faq_items'; ?> btn btn-success"><i class="icon-book icon-white"></i> <?php _e( 'add new question', 'Nevada' ); ?></a></p>
					
					</div>
					
					<div class="lambda-opttitle">
					<div class="lambda-opttitle-pad">
						<span class="miniicon"></span><?php _e( 'Additional Content to display beneath the FAQ', 'Nevada' ); ?>
					</div>
					</div>
					<div class="lambda-settings-pad">
	...
	<div class="container block">
			...
			<div id="home-tabs-contents" class="twelve columns">
				...
				<div id="home-service-columns" class="home-service-columns tab-pane">
					...
					<div class="lambda-opttitle">
						<div class="lambda-opttitle-pad">
							<span class="miniicon"><img src="<?php echo THEME_WEB_ROOT; ?>/lambda/assets/images/icons/layout_add.png"></span><?php _e( 'Service Columns', 'Nevada' ); ?>
						</div>
					</div>
					<div class="lambda-settings-pad">
				...
				<div id="home-portfolio-items" class="home-portfolio-items tab-pane">
					...
					<div class="lambda-opttitle">
						<div class="lambda-opttitle-pad">
							<span class="miniicon"><img src="<?php echo THEME_WEB_ROOT; ?>/lambda/assets/images/icons/add.png"></span><?php _e( 'Portfolio Items', 'Nevada' ); ?>
						</div>
					</div>
					<div class="lambda-settings-pad">
					...
					<div class="lambda-opttitle">
						<div class="lambda-opttitle-pad">
							<span class="miniicon"><img src="<?php echo THEME_WEB_ROOT; ?>/lambda/assets/images/icons/add.png"></span><?php _e( 'Portfolio Settings', 'Nevada' ); ?>
						</div>
					</div>
					<div class="lambda-settings-pad">
					...
					<div id="home-blog-excerpt" class="home-blog-excerpt tab-pane">
						...
						<div class="lambda-opttitle">
						<div class="lambda-opttitle-pad">
							<span class="miniicon"><img src="<?php echo THEME_WEB_ROOT; ?>/lambda/assets/images/icons/add.png"></span><?php _e( 'Blog Intro Box', 'Nevada' ); ?>
						</div>
						</div>
						<div class="lambda-settings-pad">		
					...
					<div id="home-testimonials" class="home-testimonials tab-pane">
						...
						<div class="lambda-opttitle">
							<div class="lambda-opttitle-pad">
								<span class="miniicon"><img src="<?php echo THEME_WEB_ROOT; ?>/lambda/assets/images/icons/add.png"></span><?php _e( 'Toggles & Testimonials', 'Nevada' ); ?>
							</div>
						</div>
						...
						<div class="clear"></div>
						<p style="margin-bottom:15px; padding-top:5px;"><a href="#" class="docopy-<?php echo UT_THEME_INITIAL.'home_verticaltabs'; ?> btn btn-success"><i class="icon-book icon-white"></i> <?php _e( 'add new tab', 'Nevada' ); ?></a></p>
						...
						<div class="well testimonial_type_own t-toggle">			
							...
							<div class="clear"></div>
							<p style="margin-bottom:15px; padding-top:5px;"><a href="#" class="docopy-<?php echo UT_THEME_INITIAL.'home_testimonials'; ?> btn btn-success"><i class="icon-book icon-white"></i> <?php _e( 'Add new testimonial', 'Nevada' ); ?></a></p>
					...
					<div id="home-clients" class="home-clients tab-pane">
						...
						<div class="lambda-opttitle">
							<div class="lambda-opttitle-pad">
								<span class="miniicon"><img src="<?php echo THEME_WEB_ROOT; ?>/lambda/assets/images/icons/add.png"></span><?php _e( 'Client Section', 'Nevada' ); ?>
							</div>
						</div>
						<div class="lambda-settings-pad clearfix">
						...
						<div class="clear"></div>
						<p style="margin-bottom:15px; padding-top:5px;"><a href="#" class="docopy-<?php echo UT_THEME_INITIAL.'home_clients'; ?> btn btn-success"><i class="icon-book icon-white"></i> <?php _e( 'add new tab', 'Nevada' ); ?></a></p>
					...
					<div class="lambda-opttitle">
						<div class="lambda-opttitle-pad">
							<span class="miniicon"><img src="<?php echo THEME_WEB_ROOT; ?>/lambda/assets/images/icons/add.png"></span><?php _e( 'Order the Start Elements', 'Nevada' ); ?>
						</div>
					</div>
	...
	<div class="ui-panelcontent">
	   ...
	   <div class="container block">
			...
			<div class="sixteen columns">
			   ...
			   <div class="lambda-opttitle">
					<div class="lambda-opttitle-pad">
						<span class="miniicon"><img src="<?php echo THEME_WEB_ROOT; ?>/lambda/assets/images/icons/user_comment.png"></span><?php _e( 'Manage Testimonial', 'Nevada' ); ?>
					</div>
			   </div>
			   <div class="lambda-settings-pad">
					...
					<div class="clear"></div>
					<p style="margin-bottom:15px; padding-top:5px;"><a href="#" class="docopy-<?php echo UT_THEME_INITIAL.'testimonial_items'; ?> btn btn-inverse"><i class="icon-book icon-white"></i> <?php _e( 'add new testimonial', 'Nevada' ); ?></a></p>
					
					</div>
					
					<div class="lambda-opttitle">
					<div class="lambda-opttitle-pad">
						<span class="miniicon"></span><?php _e( 'Additional Content to display beneath the Testimonials', 'Nevada' ); ?>
					</div>
					</div>
					<div class="lambda-settings-pad">
...
<div id="verticaltabs-settings" class="verticaltabs-settings tab-pane">
	...
	<div class="ui-panelcontent">
	    ...
	    <div class="container block">
		   ...
		   <div class="lambda-opttitle">
				<div class="lambda-opttitle-pad">
					<span class="miniicon"><img src="<?php echo THEME_WEB_ROOT; ?>/lambda/assets/images/icons/tabbar.png"></span><?php _e( 'Manage Tabs', 'Nevada' ); ?>
				</div>
		   </div>
		   <div class="lambda-settings-pad">
				...
				<div class="clear"></div>
				<p style="margin-bottom:15px; padding-top:5px;"><a href="#" class="docopy-<?php echo UT_THEME_INITIAL.'verticaltabs'; ?> btn btn-inverse"><i class="icon-book icon-white"></i> <?php _e( 'add new service tab', 'Nevada' ); ?></a></p>
...
<div id="client-settings" class="client-settings tab-pane">
	...
	<div class="ui-panelcontent">
	   ...
	   <div class="container block">
			...
			<div class="lambda-opttitle">
				<div class="lambda-opttitle-pad">
					<span class="miniicon"><img src="<?php echo THEME_WEB_ROOT; ?>/lambda/assets/images/icons/tabbar.png"></span><?php _e( 'Manage Layout', 'Nevada' ); ?>
				</div>
			</div>
		   ...
		   <div class="lambda-opttitle">
				<div class="lambda-opttitle-pad">
					<span class="miniicon"><img src="<?php echo THEME_WEB_ROOT; ?>/lambda/assets/images/icons/tabbar.png"></span><?php _e( 'Manage Clients', 'Nevada' ); ?>
				</div>
		   </div>
		   <div class="lambda-settings-pad">	
