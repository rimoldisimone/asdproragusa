...
<div id="lambda-option-panel" class="bootstrap-wpadmin">
  ...
  <div class="lambda-opttitle lambda-controls">
        <div class="lambda-opttitle-pad">
	 		<button class="btn btn-mini btn-inverse right" data-toggle="modal" href="#layoutsettings" ><?php _e('Manage Preset', 'Nevada') ?></button>
	  		<button type="submit" class="btn btn-mini btn-success save-options right" name="submit" /><?php _e('Save All Changes', 'Nevada') ?></button>
			<div class="clear"></div>
        </div>
  </div>
  ...
  <div class="modal-header">
    ...
    <h3><?php _e('Manage Layouts', 'Nevada') ?></h3>
    </div>
    <div class="modal-body">
			...
			<input type="submit" value="<?php _e('New Layout', 'Nevada') ?>" class="button-framework user-save-layout" name="user-save-layout" />
         	</div>
	  ...
	  <?php
				  ...
				  ?>
				  <input type="submit" value="<?php _e('Activate Layout', 'Nevada') ?>" class="btn btn-success user-activate-layout" name="user-activate-layout" style="margin-right:10px;" />

				  <?php if ( $this->has_xml ) { ?>
				  <input type="submit" value="<?php _e('Reload XML', 'Nevada') ?>" class="button-framework reload-options right" name="reload" style="margin:5px 10px 0 20px;" />
				  <?php } ?>	
	...
	<button class="btn btn-warning" data-dismiss="modal">close</button>
	  ...
	  <div id="lambda-options-panel-title">
		...
		<h1><?php echo _e(' Theme Options', 'Nevada')?></h1>
      ...
      <div class="lambda-opttitle">
            <div class="lambda-opttitle-pad settingstitle">
        		<button type="submit" class="btn btn-success save-options right" name="submit" /><i class="icon-ok icon-white"></i> <?php _e('Save All Changes', 'Nevada') ?></button>
				<button type="submit" class="btn btn-danger save-options right" name="reset" /><i class="icon-remove icon-white"></i> <?php _e('Reset Options', 'Nevada') ?></button>
				<br class="clear" />
       		</div> 
      </div>
