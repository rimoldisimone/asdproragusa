  ...
  <div id="content_wrap" class="well form-horizontal">
    ...
    <div class="lambda-opttitle">
            <div class="lambda-opttitle-pad settingstitle">
				<h1><?php echo _e('Option Usage (for Developers)', 'Nevada')?></h1>
				<div class="clear"></div>	
			</div>
    </div>
		...
		<div class="navbar">
			<div class="navbar-inner">
				...
				<ul class="options_tabs nav">
				  <li><a href="#general" data-toggle="tab">Usage &amp; Examples</a><span></span></li>
				  <li><a href="#option_types" data-toggle="tab">Option Types</a><span></span></li>
				  <li><a href="#settings" data-toggle="tab">Creating Options</a><span></span></li>
				  <li><a href="#layouts" data-toggle="tab">Adding Layouts</a><span></span></li>
				  <li><a href="#integration"data-toggle="tab">Theme Integration</a><span></span></li>
				</ul>
	...
	<div class="tab-content">	
		...
		<div id="general" class="block has-table tab-pane active">
...
?&gt;</code></pre>
        ...
        <div id="option_types" class="tab-pane">
          <h2>Option Types</h2>
        ...
        <div id="settings" class="tab-pane">
          ...
          <ul class="doc_list">
            ...
            $types = apply_filters( 'option_tree_option_types', array(
              ...
              'radio'             => 'Radio',
              'select'            => 'Select',
		        'select-sidebars'   => 'Select Sidebar',
              'slider'            => 'Slider',
				  'social'            => 'Social Media',
              'tag'               => 'Tag',
              'tags'              => 'Tags',
