  ...
  <div id="content_wrap" class="well form-horizontal">
	...
	<div class="lambda-opttitle">
            <div class="lambda-opttitle-pad settingstitle">
				<h1><?php echo _e(' Theme Settings', 'Nevada')?></h1>
				<div class="clear"></div>	
			</div>
	</div>
		  ...
		  <form method="post" action="admin.php?page=option_tree_settings&action=ot-upload-xml" enctype="multipart/form-data" id="upload-xml">
            ...
            <div class="option option-upload">
			  ...
			  <div class="section desc-text">
				...
				<input type="submit" value="<?php _e('Import XML', 'Nevada') ?>" class="btn btn-success" style="float:right;" />
				<div class="clear"></div>
		  ...
		  <form method="post" id="import-data">
            <div class="option option-input">
			  ...
			  <div class="section">
				...
				<input type="submit" value="<?php _e('Import Data', 'Nevada') ?>" class="btn btn-success import-data" style="float:right;" />
				<div class="clear"></div>
          ...
          <form method="post" id="import-layout">
            <div class="option option-input">
              ...
              <div class="section">
			    ...
			    <input type="submit" value="<?php _e('Import Layouts', 'Nevada') ?>" class="btn btn-success import-layout" style="float:right;" />
  			    <div class="clear"></div>
