...
if(is_array($memberitems)) { 
	...
	foreach($memberitems as $k=>$member) { 
		
		if($k==0){echo "<div class='clear'></div><h3 class='home-title' style='font-size: 15px;'><span>Portieri</span></h3>";$z=1;}
		if($k==3){echo "<div class='clear'></div><h3 class='home-title' style='font-size: 15px;'><span>Difensori</span></h3>";$z=1;}
		if($k==16){echo "<div class='clear'></div><h3 class='home-title' style='font-size: 15px;'><span>Centrocampisti</span></h3>";$z=1;}
		//if($k==20){echo "<div class='clear'></div><h3 class='home-title' style='font-size: 15px;'><span>Mezzepunte</span></h3>";$z=1;}
		if($k==30){echo "<div class='clear'></div><h3 class='home-title' style='font-size: 15px;'><span>Attaccanti</span></h3>";$z=1;}
