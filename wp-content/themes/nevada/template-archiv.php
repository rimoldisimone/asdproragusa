...
<section class="one_fourth">
	<article>
		...
		<ul class="archive">
				...
				<h3 class="archiv-title"><?php _e('Last 30 Posts', 'Nevada' ) ?></h3>
		...
		<section class="one_fourth">
			<article>        
				...
				<ul class="archive">
                        ...
                        <h3 class="archiv-title"><?php _e('Top 10 Likes', 'Nevada' ) ?></h3>
				...
				<?php
					...
					if(is_array($posts)) {
						...
						echo '<li>'.__('No posts voted yet.', 'Nevada').'</li>';
		...
		<section class="one_fourth">
			<article>
                ...
                <ul class="archive">
                        ...
                        <h3 class="archiv-title"><?php _e('Archives by Subject:', 'Nevada' ) ?></h3>
                    	<ul>
         ...
         <section class="one_fourth last">
			<article>
                ...
                <ul class="archive">
                        ...
                        <h3 class="archiv-title"><?php _e('Archives by Month:', 'Nevada' ) ?></h3>
